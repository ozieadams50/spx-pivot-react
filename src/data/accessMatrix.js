...
export const MENU_ITEMS = [
  ...
  { key: 'apps/eod-moc/closing-window',               label: 'Closing Window',          level: 2 },
  ...
  { key: 'admin/pre-earnings',                              label: 'Pre-Earnings',            level: 1 },
  { key: 'admin/pre-earnings/model-compare',                label: 'Model Refit Compare',      level: 2 },
...
export const DEFAULT_MATRIX = {
  ...
  'apps/eod-moc/closing-window':                     { subscriber: true,  admin: true,  superuser: true  },
  ...
  'admin/pre-earnings':                             { subscriber: false, admin: true,  superuser: true  },
  'admin/pre-earnings/model-compare':               { subscriber: false, admin: true,  superuser: true  },
